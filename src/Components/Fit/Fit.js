...
class Fit extends Component {
  ...
  render() {
    const text = {
      ...
      descricao: 'Ser fitness vai muito além do que ter aquele corpão sarado de academia. O conceito evoluiu muito e, felizmente, não se refere apenas à prática de atividade física com objetivos estéticos. É muito mais que isso: fitness é a busca pelo bem estar! É o potencializador de diversas atitudes positivas que podem deixar nossa vida muito mais saudável. Procure atividades físicas diferentes e tente encaixá-las em seus momentos de lazer. Eu não canso de falar que uma corridinha ou pedalada ao ar livre são ótimas para dar uma descontraída no fim de semana! O mesmo vale para alimentação. E, você, o que está esperando para investir em uma vida mais saudável e equilibrada?',
      descricao2: 'Comece pela teoria, nossos E-Books ensinam tudo o que você precisa saber para ter uma vida mais feliz e saudável.'
    }
